...
import kotlinx.android.synthetic.main.activity_address_list.tv_title_address_list
...
class AddEditAddress : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mAddressDetails != null) {
            if (mAddressDetails!!.id.isNotEmpty()) {
                ...
                tv_title_address_list.text = resources.getString(R.string.title_edit_address)
        ...
        val otherDetails: String = et_other_details.text.toString().trim { it <= ' ' }
                ...
                if (validateData()) {
                    ...
                    if (mAddressDetails != null && mAddressDetails!!.id.isNotEmpty()) {
                        ...
                        FirestoreClass().addAddress(this@AddEditAddress, addressModel)
                    }
                }
            }
    ...
    private fun validateData(): Boolean {
        return when {
            ...
            TextUtils.isEmpty(et_phone_number.text.toString()
                .trim { it <= ' ' }) -> {
                showErrorSnackBar(
